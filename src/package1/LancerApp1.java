...
public class LancerApp1 {
	...
	public static void main(String[] args) throws IOException {
		...
		IObjectDessinable[] lesTrains= new IObjectDessinable[10];
		...
		d.ajouterObjet(new Etoile(255,350,20,1,new Color(0,255,0),new Color(0,255,0)));
		d.ajouterObjet(new PolygoneRegulier(5,255,150,20,1,new Color(0),new Color(0)));
